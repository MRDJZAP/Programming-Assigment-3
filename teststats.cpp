...
void Test1x2_0_0__1_0var() {
  ...
  if (9063 - s.GetVar(ul, 2, 1) <= 3 && 9063 - s.GetVar(ul, 2, 1) >= 0) {
    cout << "Test case " << FG_GREEN << "passed" << FG_DEFAULT << "." << endl;
  } else {
    cout << "Test case " << FG_RED << "failed" << FG_DEFAULT << "." << endl;
  }
...
void Test2x1_0_0__0_1var() {
  ...
  if (9063 - s.GetVar(ul, 1, 2) <= 3 && 9063 - s.GetVar(ul, 1, 2) >= 0) {
    cout << "Test case " << FG_GREEN << "passed" << FG_DEFAULT << "." << endl;
  } else {
    cout << "Test case " << FG_RED << "failed" << FG_DEFAULT << "." << endl;
  }
...
void Test3x2_0_0__2_1var() {
  ...
  if (70004 - s.GetVar(ul, 3, 2) <= 3 && 70004 - s.GetVar(ul, 3, 2) >= 0) {
    cout << "Test case " << FG_GREEN << "passed" << FG_DEFAULT << "." << endl;
  } else {
    cout << "Test case " << FG_RED << "failed" << FG_DEFAULT << "." << endl;
  }
...
void Test3x2_0_1__1_1var() {
  ...
  if (5001 - s.GetVar(ul, 2, 1) <= 3 && 5001 - s.GetVar(ul, 2, 1) >= 0) {
    cout << "Test case " << FG_GREEN << "passed" << FG_DEFAULT << "." << endl;
  } else {
    cout << "Test case " << FG_RED << "failed" << FG_DEFAULT << "." << endl;
  }
...
void Test3x2_1_0__1_1var() {
  ...
  if (10000 - s.GetVar(ul, 1, 2) <= 3 && 10000 - s.GetVar(ul, 1, 2) >= 0) {
    cout << "Test case " << FG_GREEN << "passed" << FG_DEFAULT << "." << endl;
  } else {
    cout << "Test case " << FG_RED << "failed" << FG_DEFAULT << "." << endl;
  }
...
void Test3x4_1_1__2_3var() {
  ...
  if (35002 - s.GetVar(ul, 2, 3) <= 3 && 35002 - s.GetVar(ul, 2, 3) >= 0) {
    cout << "Test case " << FG_GREEN << "passed" << FG_DEFAULT << "." << endl;
  } else {
    cout << "Test case " << FG_RED << "failed" << FG_DEFAULT << "." << endl;
  }
